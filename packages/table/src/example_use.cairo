...
fn test_fn() {
    ...
    IFooTable::inserts_field::<
        FooColumns::name,
    >([(key_1.clone(), @a_byte_array), (key_2.clone(), @a_byte_array)]);
    IFooTable::inserts_field::<
        FooColumns::name,
    >([(@key_1, @a_byte_array), (@key_2, @a_byte_array)]);
    IFooTable::inserts_field::<FooColumns::name>([(12, @a_byte_array), (12, @a_byte_array)].span());
    IFooTable::inserts_field::<FooColumns::name>(@[(12, @a_byte_array), (12, @a_byte_array)]);
