...
use crate::{Spannable, ToSnapshot};
...
impl SerialisedRecordKeyImpl<
    ...
    impl SS: ToSnapshot<@SR, Struct::Record>,
    +Drop<SR>,
    +Drop<K>,
...
pub impl TablePrimaryIdImpl<
    ...
    impl SS: ToSnapshot<@K, Struct::Primary>,
...
impl ColumnSSFelt252Id<
    C, impl Struct: TableStructure, impl SS: ToSnapshot<@C, felt252>,
...
pub trait MemberTrait<R, impl Struct: TableStructure, const ID: felt252> {
    type Type;
    fn serialize_member<F, +ToSnapshot<F, Self::Type>, +Drop<F>>(self: F, ref data: Array<felt252>);
    fn serialize_member_inline<F, +ToSnapshot<F, Self::Type>, +Drop<F>>(
        self: F,
    ) -> Span<
        felt252,
    > {
...
> of RecordField<ID, KF, Struct, M> {
    fn serialize_id_field(self: @KF) -> (felt252, Span<felt252>) {
        let (key, field) = ToSnapshot::to_snapshot(self);
...
pub mod table_member {
    ...
    > of super::MemberTrait<Struct::Record, Struct, ID> {
        type Type = M;
        #[inline]
        fn serialize_member<F, +ToSnapshot<F, Self::Type>, +Drop<F>>(
