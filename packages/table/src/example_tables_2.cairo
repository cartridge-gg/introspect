...
impl Foo2TablePrimary of introspect_table::table::TablePrimary<Foo2> {
    type Primary = felt252;
    type Key = (u128, ByteArray);
    fn primary_def() -> PrimaryDef {
        PrimaryDef { name: "key_1", type_def: PrimaryTypeDef::U128, attributes: [].span() }
    }
